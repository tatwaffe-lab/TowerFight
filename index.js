...
const FIELD_W = 960;
const FIELD_H = 540;
const CELL = 40;              // Rastergröße fürs Bauen
const PATH_CLEARANCE = 30;    // Mindestabstand einer Bauzelle zur Wegmitte
